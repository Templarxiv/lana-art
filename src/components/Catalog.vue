        ...
        <div class="uk-container">
            <section class="Grid">
                <div class="Grid-row"><a class="Card" onClick="openGallery(1)" id="card-1">
                        <div class="Card-thumb">
                            ...
                            <div class="Card-shadow"></div>
                            <div class="Card-shadow"></div>
                            <div class="Card-image" style="background-image: url(./public/portrait.jpg)"></div>
                        </div>
                        <div class="Card-title"><span>Портрет</span></div>
                        <div class="Card-explore"><span>смотреть</span></div>
            ...
            <section class="Gallery" id="gallery-1">
                ...
                <div class="Gallery-images">
                    ...
                    <div class="Gallery-image Gallery-image--primary"
                        style="background-image: url(https://robohash.org/1)"></div>
                </div>
                <div class="Gallery-images">
                    <div class="Gallery-image"></div>
                    <div class="Gallery-image"></div>
            ...
            <section class="Gallery" id="gallery-2">
                ...
                <div class="Gallery-images">
                    ...
                    <div class="Gallery-image Gallery-image--primary"
                        style="background-image: url(https://robohash.org/2)"></div>
                </div>
                <div class="Gallery-images">
                    <div class="Gallery-image"></div>
                    <div class="Gallery-image"></div>
            ...
            <section class="Gallery" id="gallery-3">
                ...
                <div class="Gallery-images">
                    ...
                    <div class="Gallery-image Gallery-image--primary"
                        style="background-image: url(https://robohash.org/3)"></div>
                </div>
                <div class="Gallery-images">
                    <div class="Gallery-image"></div>
                    <div class="Gallery-image"></div>
